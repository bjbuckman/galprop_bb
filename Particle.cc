...
int Particle::create_transport_arrays()
{
    ...
    if(n_spatial_dimensions==2) {
        ...
        v_conv_x                   .init(n_rgrid, n_zgrid, n_pgrid);
        v_conv_z                   .init(n_rgrid, n_zgrid, n_pgrid);
...
void Particle::print()
{
    ...
    if(n_spatial_dimensions==2) {
        ...
        cout<<"r grid:"<<endl;
        for(int ir=0; ir<n_rgrid; ir++) cout<<r[ir]<<" ";
        cout<<endl;
        cout<<"z grid:"<<endl;
        for(int iz=0; iz<n_zgrid; iz++) cout<<z[iz]<<" ";
        cout<<endl;
        cout<<"p grid:"<<endl;
        for(int ip=0; ip<n_pgrid; ip++) cout<<p[ip]<<" ";
        cout<<endl;
        cout<<"Etot grid:"<<endl;
        for(int ip=0; ip<n_pgrid; ip++) cout<<Etot[ip]<<" ";
        cout<<endl;
        cout<<"Ekin grid:"<<endl;
        for(int ip=0; ip<n_pgrid; ip++) cout<<Ekin[ip]<<" ";
        cout<<endl;
        cout<<"beta grid:"<<endl;
        for(int ip=0; ip<n_pgrid; ip++) cout<<beta[ip]<<" ";
        cout<<endl;
        cout<<"gamma grid:"<<endl;
        for(int ip=0; ip<n_pgrid; ip++) cout<<gamma[ip]<<" ";
        cout<<endl;
        cout<<"rigidity grid:"<<endl;
        for(int ip=0; ip<n_pgrid; ip++) cout<<rigidity[ip]<<" ";
        cout<<endl;
...
//cout<<"secondary_source_function[0][0].s[0]="<<secondary_source_function.d2[0][0].s[0]<<endl;
    ...
    if(n_spatial_dimensions==3) {
        ...
        cout<<"x grid:"<<endl;
        for(int ix=0; ix<n_xgrid; ix++) cout<<x[ix]<<" ";
        cout<<endl;
        cout<<"y grid:"<<endl;
        for(int iy=0; iy<n_ygrid; iy++) cout<<y[iy]<<" ";
        cout<<endl;
        cout<<"z grid:"<<endl;
        for(int iz=0; iz<n_zgrid; iz++) cout<<z[iz]<<" ";
        cout<<endl;
