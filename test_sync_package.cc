...
int test_sync_package()
{
    ...
    name = "circular2";
    parameters[0]=1e-6;
    parameters[1]=2e-6; // parameters: Breg, Bran
    name = "spiral";
    parameters[0]=1e-6;
    parameters[1]=20.;
    parameters[2]=2e-6; // parameters: Breg, pitch_angle (deg), Bran
    name = "galprop_original";
    parameters[0]= 50100010; // as B_field_model.cc, galdef.B_field_model coded as parameter, avoid leading zeros, taken as hex!
