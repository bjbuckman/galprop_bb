...
public:
    ...
    // Inner high res area
    double x_min_inner, x_max_inner, dx_inner;
    double y_min_inner, y_max_inner, dy_inner;
    double z_min_inner, z_max_inner, dz_inner;
    ...
    Distribution   free_free_absorb; //BJB20170308
    ...
    int count_grid_points(double min, double max, double d, double min_inner, double max_inner, double d_inner);
