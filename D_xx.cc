...
// end of the test area
            ...
            if(n_spatial_dimensions==2) {
                ...
                //B-field depdendence of D_xx //BJB20161116
                particle.Dxx.d2[ir][iz].s[ip]*= pow(galaxy.B_field.d2[ir][iz].s[0]/(galdef.D_B_0/1.e4), galdef.D_B_p);
            }
            if(n_spatial_dimensions==3) {
                ...
                //B-field depdendence of D_xx //BJB20161116
                particle.Dxx.d3[ix][iy][iz].s[ip]*= pow(galaxy.B_field.d3[ix][iy][iz].s[0]/(galdef.D_B_0/1.e4), galdef.D_B_p);
            }
        }
        ...
        if(galdef.Diffusion_aniso==1) {
            if(n_spatial_dimensions==2) {
                ...
                //B-field depdendence of D_zz //BJB20161116
                particle.Dzz.d2[ir][iz].s[ip]*= pow(galaxy.B_field.d2[ir][iz].s[0]/(galdef.D_B_0/1.e4), galdef.D_B_p);
            }
            if(n_spatial_dimensions==3) {
                ...
                //B-field depdendence of D_zz //BJB20161116
                particle.Dzz.d3[ix][iy][iz].s[ip]*= pow(galaxy.B_field.d3[ix][iy][iz].s[0]/(galdef.D_B_0/1.e4), galdef.D_B_p);
            }
        }
