...
double total_time   = 0.;
double last_max     = 0;
Distribution last_cr_density,diff_cr_density,diff_cr_density2;
}
//**.****|****.****|****.****|****.****|****.****|****.****|****.****|****.****|
...
)
{
    ...
    if(number_of_calls==0) {
        ...
        diff_cr_density2=particle.cr_density;
//last_cr_density.print();
    ...
    if(number_of_calls>0) {
        ...
        diff_cr_density/= particle.cr_density;
        diff_cr_density2 = diff_cr_density;
        ...
        if(galdef.control_diagnostics==1) {
            INFO("diff_cr_density");
            diff_cr_density.print();
        }
    }
...
//Gulli20070821
    ...
    */
    ...
    double tolerance = 1.0e-12;                              //AWS20110121  i.e. require machine accuracy
    ...
    buf<< " max+ frac diff wrt last CR="<<diff_cr_density2.max();
    buf<< " max- frac diff wrt last CR="<<diff_cr_density2.min();
    buf<< " min frac diff wrt last CR="<<diff_cr_density.min();
    buf<< " max CR="<<particle.cr_density.max();
    buf<< " min CR="<<particle.cr_density.min();
