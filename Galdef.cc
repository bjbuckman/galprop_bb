                   ...
                   const string& galdefDirectory )
{
    ...
    // High-res x-grid
    strcpy ( parstring,                              "x_min_inner" );
    stat= read_galdef_parameter ( filename,parstring,&x_min_inner );
    strcpy ( parstring,                              "x_max_inner" );
    stat= read_galdef_parameter ( filename,parstring,&x_max_inner );
    strcpy ( parstring,                              "dx_inner" );
    stat= read_galdef_parameter ( filename,parstring,&dx_inner );

    // High-res y-grid
    strcpy ( parstring,                              "y_min_inner" );
    stat= read_galdef_parameter ( filename,parstring,&y_min_inner );
    strcpy ( parstring,                              "y_max_inner" );
    stat= read_galdef_parameter ( filename,parstring,&y_max_inner );
    strcpy ( parstring,                              "dy_inner" );
    stat= read_galdef_parameter ( filename,parstring,&dy_inner );

    // High-res z-grid
    strcpy ( parstring,                              "z_min_inner" );
    stat= read_galdef_parameter ( filename,parstring,&z_min_inner );
    strcpy ( parstring,                              "z_max_inner" );
    stat= read_galdef_parameter ( filename,parstring,&z_max_inner );
    strcpy ( parstring,                              "dz_inner" );
    stat= read_galdef_parameter ( filename,parstring,&dz_inner );
    ...
    // diffusion coefficient B-field parametrization
    strcpy ( parstring,                              "D_B_0" );      	//BJB20161116
    stat= read_galdef_parameter ( filename,parstring,&D_B_0 );		//BJB20161116
    strcpy ( parstring,                              "D_B_p" );	//BJB20161116
    stat= read_galdef_parameter ( filename,parstring,&D_B_p );		//BJB20161116
    ...
    strcpy ( parstring,                              "r0_conv" );        //BJB20161202
    stat= read_galdef_parameter ( filename,parstring,&r0_conv  );        //BJB20161202
    strcpy ( parstring,                              "r1_conv" );        //BJB20161202
    stat= read_galdef_parameter ( filename,parstring,&r1_conv  );        //BJB20161202
    strcpy ( parstring,                              "v0_conv_x" );        //BJB20161202
    stat= read_galdef_parameter ( filename,parstring,&v0_conv_x  );        //BJB20161202
    strcpy ( parstring,                              "v0_conv_z" );        //BJB20161202
    stat= read_galdef_parameter ( filename,parstring,&v0_conv_z  );        //BJB20161202
    ...
    // injection spectra.
    strcpy ( parstring,                              "nuc_g_1_inner" );
    stat= read_galdef_parameter ( filename,parstring,&nuc_g_1_inner );
    strcpy ( parstring,                              "nuc_g_2_inner" );
    stat= read_galdef_parameter ( filename,parstring,&nuc_g_2_inner );
    strcpy ( parstring,                              "electron_g_0_inner" );   // ECC 1/28/2016
    stat= read_galdef_parameter ( filename,parstring,&electron_g_0_inner );
    strcpy ( parstring,                              "electron_g_1_inner" );   // ECC 1/28/2016
    stat= read_galdef_parameter ( filename,parstring,&electron_g_1_inner );
    ...
    //HII cube file
    strcpy ( parstring,                              "HIICube_filename" );                //BJB20161213
    stat= read_galdef_parameter ( filename,parstring, HIICube_filename );                 //BJB20161213
    strcpy ( parstring,                              "HIICube_rlb_filename" );                //BJB20161213
    stat= read_galdef_parameter ( filename,parstring, HIICube_rlb_filename );                 //BJB20161213

    //HI norm
    strcpy ( parstring,                              "HI_norm"); //BJB20161012
    stat= read_galdef_parameter ( filename,parstring,&HI_norm ); //BJB20161012

    //HII norm
    strcpy ( parstring,                              "HII_norm"); //BJB20161213
    stat= read_galdef_parameter ( filename,parstring,&HII_norm ); //BJB20161213

    //CO norm
    strcpy ( parstring,                              "CO_norm"); //BJB20161213
    stat= read_galdef_parameter ( filename,parstring,&CO_norm ); //BJB20161213
    ...
    hadronic_losses=0;                                                               //AWS20150412
    strcpy ( parstring,                              "hadronic_losses" );            //AWS20150412
    stat= read_galdef_parameter ( filename,parstring,&hadronic_losses );             //AWS20150412
    hadronic_loss_model=2;                                                           //AWS20150412
    strcpy ( parstring,                              "hadronic_loss_model" );        //AWS20150412
    stat= read_galdef_parameter ( filename,parstring,&hadronic_loss_model );         //AWS20150412
    ...
    strcpy ( parstring,                              "free_free"); //BJB20170308
    stat= read_galdef_parameter ( filename,parstring,&free_free ); //BJB20170308
    ...
    strcpy ( parstring,                              "CMZ_multiplier" );
    stat= read_galdef_parameter ( filename,parstring,&CMZ_multiplier );
...
//SNR
    ...
    if ( n_B_field_parameters!=10 ) {
        FATAL("need exactly 10 B-field parameters in this version!");    //AWS20080313
        exit ( 1 );
    }
    ...
    //Analytic gas model
    gas_model_name=" ";
    strcpy ( parstring,                              "gas_model_name" );                        //BJB20170220
    stat= read_galdef_parameter ( filename,parstring,&gas_model_name  );
    n_gas_parameters=10;
    strcpy ( parstring,                              "n_gas_parameters" );                      //BJB20170220
    stat= read_galdef_parameter ( filename,parstring,&n_gas_parameters );
    strcpy ( parstring,                              "gas_model_parameters" );                  //BJB20170220
    stat = read_galdef_parameter ( filename,parstring,gas_model_parameters,n_gas_parameters );
    if ( stat!=0 )  //Default parameters if not found
        for ( int i = 0; i < n_gas_parameters; ++i ) {
            gas_model_parameters[i] = -i-1;
        }
    ...
    strcpy ( parstring,                              "r0_normalize" );
    stat= read_galdef_parameter ( filename,parstring,&r0_normalize );
...
void Galdef::print()
{
    ...
    cout<<"  Diffusion_aniso  "<<Diffusion_aniso <<endl; //AWS20131017
    ...
    cout<<"  D_B_0            "<<D_B_0           <<endl; //BJB20161117
    cout<<"  D_B_p            "<<D_B_p           <<endl; //BJB20161117
    ...
    cout<<"  nuc_g_1_inner "<<nuc_g_1_inner   <<endl; //ECC 1/29/2015
    cout<<"  nuc_g_2_inner "<<nuc_g_2_inner   <<endl; //ECC 1/29/2015
    ...
    cout<<"  electron_g_0_inner "<<electron_g_0_inner   <<endl;
    cout<<"  electron_g_1_inner "<<electron_g_1_inner   <<endl;
    ...
    cout<<"  HI_norm           "<<HI_norm             <<endl;//BJB20161012
    cout<<"  HII_norm          "<<HII_norm            <<endl;//BJB20161012
    cout<<"  CO_norm           "<<CO_norm             <<endl;//BJB20161012

    cout<<"  HICube_filename   "<<HICube_filename        <<endl;//BJB20161213
    cout<<"  COCube_filename   "<<COCube_filename        <<endl;//BJB20161213
    cout<<"  HIICube_filename  "<<HIICube_filename       <<endl;//BJB20161213
    ...
    cout<<"  hadronic_losses   "  <<hadronic_losses    <<endl;
    cout<<"  hadronic_loss_model "<<hadronic_loss_model<<endl;
    ...
    cout<<"  CMZ_multiplier        "<<CMZ_multiplier <<endl;
    ...
    cout<<"  B_field_parameters    ";
    for ( int i=0; i<n_B_field_parameters; i++ ) {
        cout<< B_field_parameters[i]<<"  ";
    }
    cout<<endl;   //AWS20080313

    cout<<"  gas_model_name        "<<gas_model_name         <<endl;  //BJB20170220
    cout<<"n_gas_parameters        "<<n_gas_parameters       <<endl;  //BJB20170220
    cout<<"  gas_model_parameters  ";
    for ( int i=0; i<n_gas_parameters; i++ ) {
        cout<< gas_model_parameters[i]<<"  ";
    }
    cout<<endl;  //BJB20170220
    ...
    if ( ISRF_filetype == 1 ) {
        FATAL(" ERROR: invalid ISRF_filetype, see README for details");    //AWS20091013
        exit ( 0 );
    }

    cout<<"    r0_normalize        "<<  r0_normalize   <<endl;
    ...
    cout<<"  free_free             "<<free_free            <<endl;  //BJB20170308
...
void AssignDefaultParameters ( Galdef& g )
{
    ...
    g.D_B_0                = 1.0e-6;  //BJB20161117
    g.D_B_p                = -1.;     //BJB20151117
    ...
    g.r0_conv              = 1.; //BJB161202
    g.r1_conv              = 1.; //BJB161202
    g.v0_conv_x            = 0.; //BJB161202
    g.v0_conv_z            = 0.; //BJB161202

    g.nuc_g_0              =1.50;  //AWS20131111
    g.nuc_rigid_br0        =1.0e0; //AWS20131111
    g.nuc_g_1              =1.82;  //AWS20131111
    g.nuc_g_1_inner        =-100;  //ECC 1/28/2015 default to crazy small number as indicator of not being set.
    g.nuc_g_2_inner        =-100;
    ...
    g.electron_g_0         =1.60;
    g.electron_g_0_inner   =-100;  //ECC 1/28/2015 default to crazy small number as indicator of not being set.
    g.electron_g_1_inner   =-100;  //ECC 1/28/2015 default to crazy small number as indicator of not being set.
    ...
    strcpy ( g.HIICube_filename," " ); //BJB20161213

    g.HI_norm              = 1.; //BJB20161012
    g.HII_norm             = 1.; //BJB20161012
    g.CO_norm              = 1.; //BJB20161012
...
//  g.ISRF_factors[2]      = 1.0;
    ...
    g.CMZ_multiplier  = 1.0; //EC20141112
