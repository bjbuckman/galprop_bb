...
double hadronic_energy_loss(int A, double Etot, double nhcm3, double he_to_h,int method, int debug=0); //AWS20150412
...
double nHI_3D(double, double, double,const std::string &,const std::vector<double> &);  //BJB20170220
double nH_av_3D(double, double, double, double, double,const std::string &,const std::vector<double>&, double(*)(double,double,double,const std::string &,const std::vector<double>&)); //BJB20170220
