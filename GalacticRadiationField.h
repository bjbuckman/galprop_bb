...
public:
    ...
    const std::valarray<double>& GetWavelengthData() const
    {
        return fWavelengthData;
    }
    const std::valarray<double>& GetAzimuthData() const
    {
        return fAzimuthData;
    }
    const std::valarray<double>& GetCosZenithData() const
    {
        return fCosZenithData;
    }
    const std::valarray<double>& GetRData() const
    {
        return fRData;
    }
    const std::valarray<double>& GetZData() const
    {
        return fZData;
    }
