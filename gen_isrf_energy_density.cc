...
//		  double sum1=0., sum2=0.;
                    ...
                    */
                    ...
                    if (galaxy.r[ir]==0 && galaxy.z[iz]==0) {

                        ostringstream buf;
                        buf<<"ISRF energy density at the Galactic Center for component" << i_comp << " in ev cm^-3=" << galaxy.ISRF_energy_density[i_comp].d2[ir][iz].s[0];
                        INFO(buf.str());
                    }
