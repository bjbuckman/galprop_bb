...
// if (protri_init==0){ //Gulli20070810
    ...
    alpha1_xx=new double[nkt];
    alpha1_yy=new double[nkt];
    alpha1_zz=new double[nkt];
    alpha1_pp=new double[nkt];
    alpha2_xx=new double[nkt];
    alpha2_yy=new double[nkt];
    alpha2_zz=new double[nkt];
    alpha2_pp=new double[nkt];
    alpha3_xx=new double[nkt];
    alpha3_yy=new double[nkt];
    alpha3_zz=new double[nkt];
    alpha3_pp=new double[nkt];

    alpha1_x0=new double[nkt];
    alpha1_y0=new double[nkt];
    alpha1_z0=new double[nkt];
