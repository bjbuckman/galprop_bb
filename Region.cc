...
const RegionType & SkyRegion::type() const
{
    return ftype;
}
const SM::Coordinate & SkyRegion::center() const
{
    return fcenter;
}
const double & SkyRegion::radius() const
{
    return fradius;
}
const double & SkyRegion::deltal() const
{
    return fdeltal;
}
const double & SkyRegion::deltab() const
{
    return fdeltab;
}
