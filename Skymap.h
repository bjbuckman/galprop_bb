...
public:
    ...
    T * lbCARarray( const int nl, const int nb, double CRVAL[3], int CRPIX[3], double CDELT[3], const bool correctSA = false) const
    {
        ...
        CDELT[0] = lres;
        CDELT[1] = bres;
        CDELT[2] = fSpectra.size() > 1 ? fSpectra[1] - fSpectra[0] : 0;
    ...
    public:
        ...
        {
            return m_index != compare.m_index;
        }
        /**\brief Return the corresponding coordinate */
        SM::Coordinate coord ()
        {
            SM::Coordinate co(m_map.pix2ang(m_index));
            return co;
        }
    };
    ...
    public:
        ...
        /**\brief Dereference operator */
        const ArraySlice<T> operator * ()
        {
            return m_map[m_index];
        }
        /**\brief Unequal operator */
        bool operator != (const constIterator compare)
        {
            return m_index != compare.m_index;
        }
        /**\brief Return the corresponding coordinate */
    ...
    Iterator end()
    {
        return Iterator(npix_, *this);
    }
    /** \overload */
    constIterator end() const
    {
        return constIterator(npix_, *this);
    }
