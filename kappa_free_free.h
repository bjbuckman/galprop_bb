...
// double kappa_free_free_2D(double nu, int ir, int iz,  double Te, double clumping_factor, double &emiss_free_free, int options, int debug); //BJB20170308
...
// double kappa_free_free_3D(double nu, int ix, int iy, int iz,  double Te,  double clumping_factor, double &emiss_free_free, int options, int debug); //BJB20170308
