...
{
    cout<<" >>>> read_gas_cubes TESTBLAH"<<type<<endl;
    int status=0;
    fitsfile *fptr;
    ...
    if( !strcmp ("HICube",type) ) {
        filename += galdef.HICube_filename;   //strcat(filename,galdef.HIR_filename);
    }
    if( !strcmp ("COCube",type) ) {
        filename += galdef.COCube_filename;   //strcat(filename,galdef.COR_filename);
    }
    if( !strcmp ("HIICube",type) ) {
        filename += galdef.HIICube_filename;   //strcat(filename,galdef.HIR_filename);
    }
    if( !strcmp ("COCube_rlb",type) ) {
        filename += galdef.COCube_rlb_filename;   //strcat(filename,galdef.COR_filename);
    }
    if( !strcmp ("HICube_rlb",type) ) {
        filename += galdef.HICube_rlb_filename;   //strcat(filename,galdef.COR_filename);
    }
    if( !strcmp ("HIICube_rlb",type) ) {
        filename += galdef.HIICube_rlb_filename;   //strcat(filename,galdef.COR_filename);
    }
    ...
    if( fits_open_file(&fptr,filename.c_str(),READONLY,&status) ) {
        ...
        if (!strcmp ("HIICube",type)) {
            throw std::runtime_error("Failed to open HII data cube \"" + filename + "\". Check HIICube_filename in galdef.");
        }
        if (!strcmp ("HIICube_rlb",type)) {
            throw std::runtime_error("Failed to open HII_rlb data cube \"" + filename + "\".  Check HIICube_rlb_filename in galdef.");
        }
    }
    ...
    if (!strcmp ("HICube",type)) {
        ...
        HICubeData.NAXIS1 = NAXIS1;
        HICubeData.NAXIS2 = NAXIS2;
        HICubeData.NAXIS3 = NAXIS3;
        HICubeData.CRVAL1 = CRVAL1;
        HICubeData.CRVAL2 = CRVAL2;
        HICubeData.CRVAL3 = CRVAL3;
        HICubeData.CDELT1 = CDELT1;
        HICubeData.CDELT2 = CDELT2;
        HICubeData.CDELT3 = CDELT3;
        HICubeData.total  = -1;
    }

    else if (!strcmp ("HICube_rlb",type)) {
        HICubeData_rlb.Data = image;
        HICubeData_rlb.NAXIS1 = NAXIS1;
        HICubeData_rlb.NAXIS2 = NAXIS2;
        HICubeData_rlb.NAXIS3 = NAXIS3;
        HICubeData_rlb.CRVAL1 = CRVAL1;
        HICubeData_rlb.CRVAL2 = CRVAL2;
        HICubeData_rlb.CRVAL3 = CRVAL3;
        HICubeData_rlb.CDELT1 = CDELT1;
        HICubeData_rlb.CDELT2 = CDELT2;
        HICubeData_rlb.CDELT3 = CDELT3;
        HICubeData_rlb.total  = -1;
    }

    else if (!strcmp ("COCube",type)) {
        COCubeData.Data = image;
        COCubeData.NAXIS1 = NAXIS1;
        COCubeData.NAXIS2 = NAXIS2;
        COCubeData.NAXIS3 = NAXIS3;
        COCubeData.CRVAL1 = CRVAL1;
        COCubeData.CRVAL2 = CRVAL2;
        COCubeData.CRVAL3 = CRVAL3;
        COCubeData.CDELT1 = CDELT1;
        COCubeData.CDELT2 = CDELT2;
        COCubeData.CDELT3 = CDELT3;
        COCubeData.total  = -1;
    }

    else if (!strcmp ("COCube_rlb",type)) {
        COCubeData_rlb.Data = image;
        COCubeData_rlb.NAXIS1 = NAXIS1;
        COCubeData_rlb.NAXIS2 = NAXIS2;
        COCubeData_rlb.NAXIS3 = NAXIS3;
        COCubeData_rlb.CRVAL1 = CRVAL1;
        COCubeData_rlb.CRVAL2 = CRVAL2;
        COCubeData_rlb.CRVAL3 = CRVAL3;
        COCubeData_rlb.CDELT1 = CDELT1;
        COCubeData_rlb.CDELT2 = CDELT2;
        COCubeData_rlb.CDELT3 = CDELT3;
        COCubeData_rlb.total  = -1;
    }

    else if (!strcmp ("HIICube",type)) {
        HIICubeData.Data = image;
        HIICubeData.NAXIS1 = NAXIS1;
        HIICubeData.NAXIS2 = NAXIS2;
        HIICubeData.NAXIS3 = NAXIS3;
        HIICubeData.CRVAL1 = CRVAL1;
        HIICubeData.CRVAL2 = CRVAL2;
        HIICubeData.CRVAL3 = CRVAL3;
        HIICubeData.CDELT1 = CDELT1;
        HIICubeData.CDELT2 = CDELT2;
        HIICubeData.CDELT3 = CDELT3;
        HIICubeData.total  = -1;
    }

    else if (!strcmp ("HIICube_rlb",type)) {
        HIICubeData_rlb.Data = image;
        HIICubeData_rlb.NAXIS1 = NAXIS1;
        HIICubeData_rlb.NAXIS2 = NAXIS2;
        HIICubeData_rlb.NAXIS3 = NAXIS3;
        HIICubeData_rlb.CRVAL1 = CRVAL1;
        HIICubeData_rlb.CRVAL2 = CRVAL2;
        HIICubeData_rlb.CRVAL3 = CRVAL3;
        HIICubeData_rlb.CDELT1 = CDELT1;
        HIICubeData_rlb.CDELT2 = CDELT2;
        HIICubeData_rlb.CDELT3 = CDELT3;
        HIICubeData_rlb.total  = -1;
    }
