...
namespace FPHI
{
double  delta;    // use namespace to share with  FPHI1  FPHI2
int IZ;
int Ne;
}
...
// for cf values in Fermi 2nd quadrant paper http://adsabs.harvard.edu/abs/2010ApJ...710..133A  Table 1 qHI,1=local
        ...
        for(ge1=1.0; ge1<=3.2; ge1+=0.2) {
            ...
            IZ1_list[1]=2;
            Ne_list[1]=2;
            target_abundances[1]=0.1;// He fraction by number
            ...
            IZ1_list[0]=1;
            Ne_list[0]=1;
            target_abundances[0]=1.0; // HI
            IZ1_list[1]=2;
            Ne_list[1]=2;
            target_abundances[1]=0.1 ;// He fraction by number
            IZ1_list[2]=1;
            Ne_list[2]=0;
            target_abundances[2]=0.1 ;// ionized H just test value
            IZ1_list[3]=2;
            Ne_list[3]=1;
            target_abundances[3]=0.05;// ionized He just test value
