        ...
        for(int iEgamma=0; iEgamma<galaxy.n_E_gammagrid; iEgamma++) {
            ...
            if(gcr[0].n_spatial_dimensions==2) {
                if (ir==galaxy.n_rgrid-1 || iz==galaxy.n_zgrid-1)
                    ...
                    x[0][0]=galaxy.r[ir  ];
                    x[0][1]=galaxy.z[iz+1];
                    f[0]=galaxy.DM_emiss.d2[ir  ][iz+1].s[iEgamma];
                    x[1][0]=galaxy.r[ir+1];
                    x[1][1]=galaxy.z[iz+1];
                    f[1]=galaxy.DM_emiss.d2[ir+1][iz+1].s[iEgamma];
                    x[2][0]=galaxy.r[ir  ];
                    x[2][1]=galaxy.z[iz  ];
                    f[2]=galaxy.DM_emiss.d2[ir  ][iz  ].s[iEgamma];
                    x[3][0]=galaxy.r[ir+1];
                    x[3][1]=galaxy.z[iz  ];
                    f[3]=galaxy.DM_emiss.d2[ir+1][iz  ].s[iEgamma];
            ...
            if(gcr[0].n_spatial_dimensions==3) {
                if (ix==galaxy.n_xgrid-1 || iy==galaxy.n_ygrid-1 || iz==galaxy.n_zgrid-1)
                    ...
                    x[0][1]=galaxy.z[iz+1];
                    x[0][2]=galaxy.y[iy  ];
                    f[0]=galaxy.DM_emiss.d3[ix  ][iy  ][iz+1].s[iEgamma];
                    x[1][0]=galaxy.x[ix+1];
                    x[1][1]=galaxy.z[iz+1];
                    x[1][2]=galaxy.y[iy  ];
                    f[1]=galaxy.DM_emiss.d3[ix+1][iy  ][iz+1].s[iEgamma];
                    x[2][0]=galaxy.x[ix  ];
                    x[2][1]=galaxy.z[iz  ];
                    x[2][2]=galaxy.y[iy  ];
                    f[2]=galaxy.DM_emiss.d3[ix  ][iy  ][iz  ].s[iEgamma];
                    x[3][0]=galaxy.x[ix+1];
                    x[3][1]=galaxy.z[iz  ];
                    x[3][2]=galaxy.y[iy  ];
                    f[3]=galaxy.DM_emiss.d3[ix+1][iy  ][iz  ].s[iEgamma];
                    x[4][0]=galaxy.x[ix  ];
                    x[4][1]=galaxy.z[iz+1];
                    x[4][2]=galaxy.y[iy+1];
                    f[4]=galaxy.DM_emiss.d3[ix  ][iy+1][iz+1].s[iEgamma];
                    x[5][0]=galaxy.x[ix+1];
                    x[5][1]=galaxy.z[iz+1];
                    x[5][2]=galaxy.y[iy+1];
                    f[5]=galaxy.DM_emiss.d3[ix+1][iy+1][iz+1].s[iEgamma];
                    x[6][0]=galaxy.x[ix  ];
                    x[6][1]=galaxy.z[iz  ];
                    x[6][2]=galaxy.y[iy+1];
                    f[6]=galaxy.DM_emiss.d3[ix  ][iy+1][iz  ].s[iEgamma];
                    x[7][0]=galaxy.x[ix+1];
                    x[7][1]=galaxy.z[iz  ];
                    x[7][2]=galaxy.y[iy+1];
                    f[7]=galaxy.DM_emiss.d3[ix+1][iy+1][iz  ].s[iEgamma];
